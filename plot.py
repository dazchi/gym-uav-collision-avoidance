...
# sac_score_eps = sac_score_eps[:EPS*10]
# sac_score = sac_score[:EPS*10]
# sac_score_smoothed = sac_score_smoothed[:EPS*10]
...
plt.figure()
p = plt.plot(sac_score_eps, sac_score, alpha=ALPHA)
plt.plot(sac_score_eps, sac_score_smoothed, label='SAC', color=p[0].get_color())
